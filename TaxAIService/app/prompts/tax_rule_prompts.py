...
{{
  ...
  "taxRules": [
    {{
      ...
      "condition": "Mô tả chi tiết điều kiện áp dụng hoặc ngưỡng thu nhập tính thuế. Với PIT_DEDUCTION_DEPENDENT thì bắt buộc xuất JSON eligibility như mẫu ở trên.",
